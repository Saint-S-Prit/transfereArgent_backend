...
class AppFixtures extends Fixture
{
    ...
    public function load(ObjectManager $manager)
    {
        ...
        $adminSysteme
            ...
            ->setPassword($hash)
            ->setProfil($profil->getLibelle('admin_systeme'))
        ...
        for ($i = 0; $i < rand(1, 4); $i++) {
            ...
            $caissier
                ...
                ->setPassword($hash)
                ->setProfil($profil->getLibelle('caissier'))
                ->setTelephone($faker->phoneNumber);
            ...
            for ($i = 0; $i < 1; $i++) {
                ...
                $userAgence
                    ...
                    ->setDateNaiss('16/07/1993')
                    ->setPassword($hash)
                    ->setProfil($profil->getLibelle('user_agence'))
                    ->setTelephone($faker->phoneNumber);
            ...
            for ($i = 0; $i < rand(1, 4); $i++) {
                ...
                $adminagence
                    ...
                    ->setPassword($hash)
                    ->setProfil($profil->getLibelle('admin_agence'))
                    ->setTelephone($faker->phoneNumber);
