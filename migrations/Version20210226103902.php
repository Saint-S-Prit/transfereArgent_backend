 ...
 */
final class Version20210226103902 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE agence ADD CONSTRAINT FK_64C19AA93ED2363F FOREIGN KEY (admin_agence_id) REFERENCES admin_agence (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
